  ...
  return (
    <div className="max-w-6xl mx-auto px-6 space-y-32 py-20 md:py-32">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        <div className="lg:col-span-7 space-y-10">
          ...
          <p className="text-xl md:text-2xl text-stone-600 leading-relaxed max-w-xl font-light">
            Bridging the gap between <span className="text-emerald-900 font-medium">technical code</span> and <span className="text-emerald-900 font-medium">artistic craft</span>.
          </p>
          <div className="flex flex-wrap gap-6 pt-4">
            ...
            >
              ...
              <div className="absolute inset-0 bg-emerald-700 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
            </Link>
            <Link 
              to="/resume" 
        ...
        <div className="lg:col-span-5 relative">
          ...
          <div className="absolute -bottom-6 -right-6 p-8 bg-emerald-900 text-white rounded-[2rem] shadow-2xl max-w-[220px] hidden md:block">
            ...
            <p className="text-sm font-medium serif italic leading-relaxed">FRC Robotics World Championship — Houston, TX</p>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center bg-white border border-emerald-100 p-12 md:p-24 rounded-[4rem] shadow-xl shadow-emerald-900/5 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-emerald-50/50 rounded-full -mr-32 -mt-32 blur-3xl"></div>
        <div className="space-y-8 relative">
          ...
          <div className="space-y-6 text-stone-600 leading-relaxed font-light text-lg">
            <p>
              I’m Aeri, a first-year computer science student at <strong>Colorado School of Mines</strong> who splits time between code, craft, and community. This semester I’m kicking off undergraduate research in the <strong>Edgar Mine</strong> and working at the Mines IT Service Desk—two roles that let me learn by doing and helping people every day.
            </p>
            <p>
              My favorite class is Thorson honors, where I get to learn basic design and engineering ethics in an art-forward way. I love building things, whether that’s a React app, a CAD model, or a hand-knit beanie.
            </p>
            <p>
              I’m happiest when a project brings my science and artistic sides together. When I’m not debugging for class, you’ll find me baking with friends, crocheting on the dorm floor, or exploring new ways to turn ideas into something you can hold, see, or use.
            </p>
          </div>
        </div>
        ...
        <div className="p-12 rounded-[3rem] bg-emerald-900 text-emerald-50 shadow-2xl space-y-6">
          ...
          <ul className="space-y-4">
            <li className="flex gap-4">
              ...
              <p className="font-light">Undergraduate research in the <span className="font-semibold text-white">Edgar Mine</span> with CURIE/QTSF</p>
            </li>
            <li className="flex gap-4">
              <span className="text-emerald-400 font-bold shrink-0">02</span>
              <p className="font-light">Working at the <span className="font-semibold text-white">Mines IT Service Desk</span></p>
            </li>
            <li className="flex gap-4">
              <span className="text-emerald-400 font-bold shrink-0">03</span>
              <p className="font-light">Balancing honors classes, research, and creative projects—fueled by coffee</p>
            </li>
          </ul>
        </div>
        ...
        <div className="p-12 rounded-[3rem] border-4 border-emerald-900 border-dotted space-y-6 bg-white/40">
          ...
          <ul className="space-y-4 text-stone-600">
            <li className="flex gap-4 items-start">
              <span className="w-2 h-2 mt-2 rounded-full bg-emerald-600 shrink-0"></span>
              <p className="font-light">Exploring <span className="font-semibold text-emerald-900">Quantum Engineering</span> & McBride honors track</p>
            </li>
            <li className="flex gap-4 items-start">
              <span className="w-2 h-2 mt-2 rounded-full bg-emerald-600 shrink-0"></span>
              <p className="font-light">Deeper involvement in undergraduate lab research</p>
            </li>
            <li className="flex gap-4 items-start">
              <span className="w-2 h-2 mt-2 rounded-full bg-emerald-600 shrink-0"></span>
              <p className="font-light">Colorado outdoors: snow days, mountain weekends, and community hikes</p>
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="space-y-16 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {skillGroups.map((group, index) => (
            <div key={index} className="space-y-6 p-8 rounded-[2rem] bg-emerald-50/30 border border-emerald-100/50 hover:bg-white hover:shadow-xl transition-all group">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-emerald-800 border-b border-emerald-100 pb-2">{group.title}</h3>
              <div className="flex flex-wrap gap-2">
                {group.items.map((item, idx) => (
                  <span key={idx} className="px-4 py-2 bg-white rounded-full text-[11px] font-bold text-stone-700 border border-stone-100 shadow-sm group-hover:border-emerald-200">
                    {item}
                  </span>
                ))}
              </div>
